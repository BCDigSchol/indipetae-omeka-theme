    ...
    <form action="<?php echo html_escape(url('items/batch-edit')); ?>" method="post" accept-charset="utf-8">
        ...
        <thead>
            <tr>
                ...
                $browseHeadings[__('Folder')] = 'Dublin Core,Has Format';
                $browseHeadings[__('Number')] = 'Dublin Core,Has Version';
                $browseHeadings[__('Transcribed by')] = 'Dublin Core,Contributor';
        ...
        <tbody>
            ...
            <tr class="item <?php if(++$key%2==1) echo 'odd'; else echo 'even'; ?>">
                ...
                <td><?php echo strip_formatting(metadata('item', array('Dublin Core', 'Has Format'))); ?></td>
                <td><?php echo strip_formatting(metadata('item', array('Dublin Core', 'Has Version'))); ?></td>
                <td>
                    <?php
                    echo metadata('item', array('Dublin Core', 'Contributor'), array('snippet' => 35));
                    ?>
                </td>
